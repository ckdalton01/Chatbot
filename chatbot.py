...
def validate_relevance(user_question: str, ai_message: str, threshold: int = 60) -> bool:
    ...
    Rate how relevant and helpful the assistant's response is to the user question
    on a scale of 0 to 100.
    0 = completely irrelevant, 100 = perfectly relevant.
...
if user_question:
    ...
    if is_relevant:
        ...
        with st.chat_message("assistant"):
            st.markdown("The retrieved response may not be sufficiently relevant. Please try rephrasing your question.")
